...
def _make_unit_cube_topo():
    ...
    e2v = np.array([
        [1, 2], [2, 3], [3, 4], [4, 1],   # 1-4: bottom (z=0)
        [5, 6], [6, 7], [7, 8], [8, 5],   # 5-8: top (z=1)
        [1, 5], [2, 6], [3, 7], [4, 8],   # 9-12: vertical
    ], dtype=np.int64)
...
def _make_two_cube_topo():
    ...
    e2v = np.array([
        [1, 2], [2, 3], [3, 4], [4, 1],               # 1-4
        [5, 6], [6, 7], [7, 8], [8, 5],               # 5-8
        [1, 5], [2, 6], [3, 7], [4, 8],               # 9-12
        [9, 10], [10, 11], [11, 12], [12, 9],          # 13-16
        [5, 9], [6, 10], [7, 11], [8, 12],             # 17-20
    ], dtype=np.int64)
