#!/bin/bash
# examples/halfspace-viscoelastic-mpi-cpp/compare.sh
# halfspace × viscoelastic × mpi × cpp
#
# Usage:  bash examples/halfspace-viscoelastic-mpi-cpp/compare.sh
set -euo pipefail
...
echo "=============================================================="
echo " CASE: halfspace-viscoelastic-mpi-cpp"
echo "=============================================================="
...
echo ""
echo "=============================================================="
echo " CASE halfspace-viscoelastic-mpi-cpp: PASSED"
echo "=============================================================="
