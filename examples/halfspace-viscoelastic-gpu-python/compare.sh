#!/bin/bash
# examples/halfspace-viscoelastic-gpu-python/compare.sh
# halfspace × viscoelastic × gpu × python
#
# Usage:  bash examples/halfspace-viscoelastic-gpu-python/compare.sh
set -euo pipefail
...
echo "=============================================================="
echo " CASE: halfspace-viscoelastic-gpu-python"
echo "=============================================================="
...
for DIR in x y z; do
    ...
    "${MEMLIMIT}" -- "${SOLVER}" --direction "$DIR" 2>&1 | grep "complete" || { echo "FAIL: solver failed $DIR"; exit 1; }
done
...
echo ""
echo "=============================================================="
echo " CASE halfspace-viscoelastic-gpu-python: PASSED"
echo "=============================================================="
