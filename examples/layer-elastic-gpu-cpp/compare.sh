#!/bin/bash
# examples/layer-elastic-gpu-cpp/compare.sh
# layer × elastic × gpu × cpp
#
# Usage:  bash examples/layer-elastic-gpu-cpp/compare.sh
set -euo pipefail
...
echo "=============================================================="
echo " CASE: layer-elastic-gpu-cpp"
echo "=============================================================="
...
echo ""
echo "=============================================================="
echo " CASE layer-elastic-gpu-cpp: PASSED"
echo "=============================================================="
