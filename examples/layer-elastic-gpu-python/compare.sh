#!/bin/bash
# examples/layer-elastic-gpu-python/compare.sh
# layer × elastic × gpu × python
#
# Usage:  bash examples/layer-elastic-gpu-python/compare.sh
set -euo pipefail
...
echo "=============================================================="
echo " CASE: layer-elastic-gpu-python"
echo "=============================================================="
...
echo ""
echo "=============================================================="
echo " CASE layer-elastic-gpu-python: PASSED"
echo "=============================================================="
