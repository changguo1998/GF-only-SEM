#!/bin/bash
# examples/layer-elastic-mpi-python/compare.sh
# layer × elastic × mpi × python
#
# Usage:  bash examples/layer-elastic-mpi-python/compare.sh
set -euo pipefail
...
echo "=============================================================="
echo " CASE: layer-elastic-mpi-python"
echo "=============================================================="
...
echo ""
echo "=============================================================="
echo " CASE layer-elastic-mpi-python: PASSED"
echo "=============================================================="
