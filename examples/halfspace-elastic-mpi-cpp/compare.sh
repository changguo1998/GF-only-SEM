#!/bin/bash
# examples/halfspace-elastic-mpi-cpp/compare.sh
# halfspace × elastic × mpi × cpp
#
# Usage:  bash examples/halfspace-elastic-mpi-cpp/compare.sh
set -euo pipefail
...
echo "=============================================================="
echo " CASE: halfspace-elastic-mpi-cpp"
echo "=============================================================="
...
echo ""
echo "=============================================================="
echo " CASE halfspace-elastic-mpi-cpp: PASSED"
echo "=============================================================="
