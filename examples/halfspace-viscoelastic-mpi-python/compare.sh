#!/bin/bash
# examples/halfspace-viscoelastic-mpi-python/compare.sh
# halfspace × viscoelastic × mpi × python
#
# Usage:  bash examples/halfspace-viscoelastic-mpi-python/compare.sh
set -euo pipefail
...
echo "=============================================================="
echo " CASE: halfspace-viscoelastic-mpi-python"
echo "=============================================================="
...
echo ""
echo "=== Stage 3: Forward (viscoelastic, mpi) ==="
cd "${CASE_DIR}"
SOLVER="${BIN}/gf_solver_viscoelastic_mpi"
...
echo ""
echo "=============================================================="
echo " CASE halfspace-viscoelastic-mpi-python: PASSED"
echo "=============================================================="
