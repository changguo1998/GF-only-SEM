#!/bin/bash
# examples/layer-viscoelastic-gpu-cpp/compare.sh
# layer × viscoelastic × gpu × cpp
#
# Usage:  bash examples/layer-viscoelastic-gpu-cpp/compare.sh
set -euo pipefail
...
echo "=============================================================="
echo " CASE: layer-viscoelastic-gpu-cpp"
echo "=============================================================="
...
echo ""
echo "=============================================================="
echo " CASE layer-viscoelastic-gpu-cpp: PASSED"
echo "=============================================================="
