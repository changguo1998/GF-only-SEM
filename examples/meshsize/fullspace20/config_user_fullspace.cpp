/// config_user_fullspace20.cpp — meshsize study case fullspace20
///
/// Build: cmake -B build -DGF_USER_CONFIG=examples/fullspace20/config_user_fullspace.cpp
/// (examples/meshsize/fullspace20/config_user_fullspace.cpp via CASE_DIR)
