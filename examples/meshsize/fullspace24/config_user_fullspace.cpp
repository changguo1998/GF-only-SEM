/// config_user_fullspace24.cpp — meshsize study case fullspace24
///
/// Build: cmake -B build -DGF_USER_CONFIG=examples/fullspace24/config_user_fullspace.cpp
/// (examples/meshsize/fullspace24/config_user_fullspace.cpp via CASE_DIR)
