"""Mesh-size study case: fullspace24 — homogeneous elastic full-space.
...
Mesh: regular hexahedral, 24×24×24 = 13824 elements, 750 m (4.0 elem/λs, 6.7 elem/λp), PML 7 = 5.25 km
