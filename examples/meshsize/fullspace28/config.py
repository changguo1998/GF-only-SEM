"""Mesh-size study case: fullspace28 — homogeneous elastic full-space.
...
Mesh: regular hexahedral, 28×28×28 = 21952 elements, 643 m (4.7 elem/λs, 7.8 elem/λp), PML 8 = 5.14 km
...
tilex_elements = [3, 3, 3, 3]  # sums to 12 = nx - pml_xmin - pml_xmax
tiley_elements = [3, 3, 3, 3]  # sums to 12 = ny - pml_ymin - pml_ymax
...
pml_thickness = {
    ...
    "ymin": 8,
    "ymax": 8,
    "zmin": 8,  # PML on bottom (no free surface!)
    "zmax": 8,  # PML on top
}
