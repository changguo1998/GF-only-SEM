/// config_user_fullspace22.cpp — meshsize study case fullspace22
///
/// Build: cmake -B build -DGF_USER_CONFIG=examples/fullspace22/config_user_fullspace.cpp
/// (examples/meshsize/fullspace22/config_user_fullspace.cpp via CASE_DIR)
...
Config get_config() {
    ...
    c.pml_ymin = 6;
    c.pml_ymax = 6;
    c.pml_zmin = 6;  // PML on bottom — no free surface
    c.pml_zmax = 6;  // PML on top
    c.source_x_m = 9375.0;
    c.source_y_m = 9375.0;
    c.source_z_m = 9375.0;
