/// config_user_fullspace18.cpp — meshsize study case fullspace18
///
/// Build: cmake -B build -DGF_USER_CONFIG=examples/fullspace18/config_user_fullspace.cpp
/// (examples/meshsize/fullspace18/config_user_fullspace.cpp via CASE_DIR)
