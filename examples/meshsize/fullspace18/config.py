"""Mesh-size study case: fullspace18 — homogeneous elastic full-space.
...
Mesh: regular hexahedral, 18×18×18 = 5832 elements, 1000 m (3.0 elem/λs, 5.0 elem/λp), PML 5 = 5.00 km
