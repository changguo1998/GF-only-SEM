#!/bin/bash
# examples/halfspace-elastic-gpu-cpp/compare.sh
# halfspace × elastic × gpu × cpp
#
# Usage:  bash examples/halfspace-elastic-gpu-cpp/compare.sh
set -euo pipefail
...
echo "=============================================================="
echo " CASE: halfspace-elastic-gpu-cpp"
echo "=============================================================="
...
echo ""
echo "=============================================================="
echo " CASE halfspace-elastic-gpu-cpp: PASSED"
echo "=============================================================="
