#!/bin/bash
# examples/halfspace-elastic-mpi-python/compare.sh
# halfspace × elastic × mpi × python
#
# Usage:  bash examples/halfspace-elastic-mpi-python/compare.sh
set -euo pipefail
...
echo "=============================================================="
echo " CASE: halfspace-elastic-mpi-python"
echo "=============================================================="
...
echo ""
echo "=============================================================="
echo " CASE halfspace-elastic-mpi-python: PASSED"
echo "=============================================================="
