/// 40 km homogeneous full-space diagnostic configuration.
...
Config get_config() {
    Config config;
    config.title = "fullspace_expanded_40cube_debug";
    config.nx_elements = 40;
    config.ny_elements = 40;
    config.lx_m = 40000.0;
    config.ly_m = 40000.0;
    config.lz_m = 40000.0;
    config.polynomial_order = 4;
    config.output_dt_s = 0.05;
    ...
    config.storage_limit_gb = 300.0;
    config.record_depth_max_m = 40000.0;
    config.tilex_elements = {8, 8, 7, 7};
    config.tiley_elements = {8, 8, 7, 7};
    config.n_ranks = 16;
    config.pml_xmin = 5;
    config.pml_xmax = 5;
    config.pml_ymin = 5;
    ...
    config.pml_zmin = 5;
    config.pml_zmax = 5;
    config.source_x_m = 20500.0;
    config.source_y_m = 20500.0;
    config.source_z_m = 20500.0;
