#!/bin/bash
# examples/layer-viscoelastic-mpi-python/compare.sh
# layer × viscoelastic × mpi × python
#
# Usage:  bash examples/layer-viscoelastic-mpi-python/compare.sh
set -euo pipefail
...
echo "=============================================================="
echo " CASE: layer-viscoelastic-mpi-python"
echo "=============================================================="
...
echo ""
echo "=============================================================="
echo " CASE layer-viscoelastic-mpi-python: PASSED"
echo "=============================================================="
