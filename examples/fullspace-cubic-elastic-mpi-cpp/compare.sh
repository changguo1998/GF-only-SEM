...
[ "$n_cell" = "5832" ] || { echo "FAIL: n_elements=$n_cell, expected 5832"; exit 1; }
...
[ "$n_tiles" -ge "4" ] || { echo "FAIL: n_tiles=$n_tiles < 4"; exit 1; }
...
python3 "${PROJECT_ROOT}/examples/_shared/analytical_compare.py" greenfun/ --source 9000.0 9000.0 9000.0 --fullspace 2>&1 || {
