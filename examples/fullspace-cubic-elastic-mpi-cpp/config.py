...
Source: point force at center (9000, 9000, 9000) m
"""
...
tilex_elements = [4, 4, 4]  # sums to 12 = nx - pml_xmin - pml_xmax
tiley_elements = [4, 4, 4]  # sums to 12 = ny - pml_ymin - pml_ymax
...
pml_thickness = {
    ...
    "ymin": 3,
    "ymax": 3,
    "zmin": 3,  # PML on bottom (no free surface!)
    "zmax": 3,  # PML on top
}
