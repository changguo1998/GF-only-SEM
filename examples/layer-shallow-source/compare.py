#!/usr/bin/env python3
"""Compare PyFK layered reference output with the SEM GreenFunctionLibrary result."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Compare PyFK layered reference output with SEM greenfun output."
    )
    ...
    parser.add_argument(
        ...
        help="Only displacement is supported by the PyFK reference script",
    )
