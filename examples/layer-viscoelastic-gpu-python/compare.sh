#!/bin/bash
# examples/layer-viscoelastic-gpu-python/compare.sh
# layer × viscoelastic × gpu × python
#
# Usage:  bash examples/layer-viscoelastic-gpu-python/compare.sh
set -euo pipefail
...
echo "=============================================================="
echo " CASE: layer-viscoelastic-gpu-python"
echo "=============================================================="
...
echo ""
echo "=============================================================="
echo " CASE layer-viscoelastic-gpu-python: PASSED"
echo "=============================================================="
