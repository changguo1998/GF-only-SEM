#!/bin/bash
# examples/layer-viscoelastic-mpi-cpp/compare.sh
# layer × viscoelastic × mpi × cpp
#
# Usage:  bash examples/layer-viscoelastic-mpi-cpp/compare.sh
set -euo pipefail
...
echo "=============================================================="
echo " CASE: layer-viscoelastic-mpi-cpp"
echo "=============================================================="
...
echo ""
echo "=============================================================="
echo " CASE layer-viscoelastic-mpi-cpp: PASSED"
echo "=============================================================="
