...
///   rank_node_residual[3 * local_element2rank_node[e*n_node+n] + d] += local_element_residual[3 * (e*n_node+n) + d]
///
...
///
/// For each element e and GLL node n,
///   local_element_field[3 * (e*n_node+n) + d] = rank_node_field[3 * local_element2rank_node[e*n_node+n] + d]
