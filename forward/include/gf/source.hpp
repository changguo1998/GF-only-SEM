...
///   src.locate(px, py, pz, coords, dxi_dx, n_local_elem, ngll);
...
public:
    ...
    /// @param[in] coords             [n_local_elem * ngll^3 * 3] GLL nodal coordinates
    /// @param[in] dxi_dx             [n_local_elem * ngll^3 * 9] inverse Jacobian per GLL node
